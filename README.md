...
```json
{
    "url": "https://firebasestorage.googleapis.com/v0/b/faithfultweaks-64-app.appspot.com/o/FaithfulTweaks%2F900000000-0000-0000-0000-000000000000.zip?alt=media&token=00000000-0000-0000-0000-000000000000"
}
```
